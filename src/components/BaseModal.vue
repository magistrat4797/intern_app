<template>
  ...
  >
    ...
    <div class="modal-container px-4 mx-auto z-50">
      <div
        class="modal-content relative py-3 sm:py-4 text-left bg-white rounded shadow-lg"
      ...
      >
        ...
        <button
          type="button"
          class="modal-close absolute right-0 -top-[35px] cursor-pointer"
          @click="closeModal"
        >
          <span
            class="inline-flex justify-center items-center text-2xl h-[35px] text-white hover:text-base-green"
          >
