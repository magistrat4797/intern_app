        ...
        <tbody>
          <tr v-for="intern in paginatedInternsList" :key="intern.id" class="odd:bg-lighter-gray">
            <td class="rounded-l w-[60px] sm:w-[130px]">
              <span
                class="block avatar overflow-hidden rounded-full w-[40px] h-[40px] sm:w-[45px] sm:h-[45px] bg-gray-200"
              >
            ...
            <td class="rounded-r w-[70px] sm:w-[130px]">
              <span class="flex items-center justify-center sm:justify-start">
                <RouterLink
                  ...
                  class="mr-2 sm:mr-5 text-light-gray hover:text-base-green"
                >
                ...
                <button
                  ...
                  class="text-light-gray hover:text-base-green"
                >
      ...
      <template #body>
        <p class="text-md sm:text-lg">
          ...
          <span class="font-bold"
            >{{ internToDelete?.first_name }} {{ internToDelete?.last_name }}</span
          >?
        </p>
      </template>
      <template #actions>
